...
TEST_F(PoolValidationTest, CreateByDefaultOptions) {
    ...
    webnn::MLOperand input = mBuilder.Input("input", &inputDesc);
    {
        ...
        webnn::MLPool2dOptions pool2dOptions = {};
        webnn::MLOperand pool = mBuilder.AveragePool2d(input, &pool2dOptions);
    }

    { webnn::MLOperand pool = mBuilder.MaxPool2d(input); }
}
