...
#include "webnn/webnn_native/dml/GraphDML.h"
...
#include "webnn/webnn_native/Utils.h"
#include "webnn/webnn_native/dml/ContextDML.h"
#include "webnn/webnn_native/dml/deps/src/precomp.h"
...
#define SLICE_ONE_AXIS(axis, index)                                                       \
    ...
    MaybeError Graph::AddSplit(const op::Split* split) {
        ...
        for (size_t i = 0; i < outputSize; ++i) {
            mExpression.insert(std::make_pair(split->Outputs()[i], output[i]));
        }
