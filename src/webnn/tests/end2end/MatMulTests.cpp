...
TEST_F(MatMulTests, MatMul1d) {
    ...
    const ml::Operand a = utils::BuildInput(builder, "a", {4});
...
TEST_F(MatMulTests, MatMul3d) {
    const ml::GraphBuilder builder = ml::CreateGraphBuilder(GetContext());
    const ml::Operand a = utils::BuildInput(builder, "a", {2, 3, 4});
...
TEST_F(MatMulTests, MatMul3dx2dGet3d) {
    const ml::GraphBuilder builder = ml::CreateGraphBuilder(GetContext());
    const ml::Operand a = utils::BuildInput(builder, "a", {1, 3, 4});
...
TEST_F(MatMulTests, MatMul4d) {
    const ml::GraphBuilder builder = ml::CreateGraphBuilder(GetContext());
    const ml::Operand a = utils::BuildInput(builder, "a", {1, 2, 3, 4});
    const std::vector<float> bData = {
