...
namespace webnn_wire {
    ...
    ReservedNamedOperands WireClient::ReserveNamedOperands() {
        return mImpl->ReserveNamedOperands();
    }

    ReservedNamedOutputs WireClient::ReserveNamedOutputs() {
        return mImpl->ReserveNamedOutputs();
    }
